...
\subsubsection[{\texorpdfstring{calc\+\_\+kepler\+\_\+orbit\+\_\+par(double \&semi, double \&peri, double \&ecc, double angle[3], double \&true\+\_\+anomaly, double \&ecc\+\_\+anomaly, double \&mean\+\_\+anomaly, const double m, const double dx[3], const double dv[3])}{calc_kepler_orbit_par(double &semi, double &peri, double &ecc, double angle[3], double &true_anomaly, double &ecc_anomaly, double &mean_anomaly, const double m, const double dx[3], const double dv[3])}}]{\setlength{\rightskip}{0pt plus 5cm}void N\+T\+A\+::calc\+\_\+kepler\+\_\+orbit\+\_\+par (
\begin{DoxyParamCaption}
\item[{double \&}]{semi, }
\item[{double \&}]{peri, }
\item[{double \&}]{ecc, }
\item[{double}]{angle\mbox{[}3\mbox{]}, }
\item[{double \&}]{true\+\_\+anomaly, }
\item[{double \&}]{ecc\+\_\+anomaly, }
\item[{double \&}]{mean\+\_\+anomaly, }
\item[{const double}]{m, }
\item[{const double}]{dx\mbox{[}3\mbox{]}, }
\item[{const double}]{dv\mbox{[}3\mbox{]}}
...
\subsubsection[{\texorpdfstring{kepler\+\_\+orbit\+\_\+generator(double x1[3], double x2[3], double v1[3], double v2[3], const double m1, const double m2, const double semi, const double ecc, const double angle[3], const double ecc\+\_\+anomaly)}{kepler_orbit_generator(double x1[3], double x2[3], double v1[3], double v2[3], const double m1, const double m2, const double semi, const double ecc, const double angle[3], const double ecc_anomaly)}}]{\setlength{\rightskip}{0pt plus 5cm}void N\+T\+A\+::kepler\+\_\+orbit\+\_\+generator (
\begin{DoxyParamCaption}
\item[{double}]{x1\mbox{[}3\mbox{]}, }
\item[{double}]{x2\mbox{[}3\mbox{]}, }
\item[{double}]{v1\mbox{[}3\mbox{]}, }
\item[{double}]{v2\mbox{[}3\mbox{]}, }
\item[{const double}]{m1, }
\item[{const double}]{m2, }
\item[{const double}]{semi, }
\item[{const double}]{ecc, }
\item[{const double}]{angle\mbox{[}3\mbox{]}, }
\item[{const double}]{ecc\+\_\+anomaly}
\end{DoxyParamCaption}
...
\subsubsection[{\texorpdfstring{Newtonian\+\_\+\+A\+W(double Aij[3], double \&\+Pij, double p\+Wij[3], double \&\+Wij, const double xij[3], const Particle \&pi, const Particle \&pj, Newtonian\+\_\+pars $\ast$pars)}{Newtonian_AW(double Aij[3], double &Pij, double pWij[3], double &Wij, const double xij[3], const Particle &pi, const Particle &pj, Newtonian_pars *pars)}}]{\setlength{\rightskip}{0pt plus 5cm}int N\+T\+A\+::\+Newtonian\+\_\+\+AW (
\begin{DoxyParamCaption}
\item[{double}]{Aij\mbox{[}3\mbox{]}, }
\item[{double \&}]{Pij, }
\item[{double}]{p\+Wij\mbox{[}3\mbox{]}, }
\item[{double \&}]{Wij, }
\item[{const double}]{xij\mbox{[}3\mbox{]}, }
\item[{const {\bf Particle} \&}]{pi, }
\item[{const {\bf Particle} \&}]{pj, }
\item[{{\bf Newtonian\+\_\+pars} $\ast$}]{pars}
\end{DoxyParamCaption}
...
\begin{center}
\leavevmode
\includegraphics[width=325pt]{namespaceNTA_aad37ae368f0a920088e180a73187685a_cgraph}
\end{center}
\end{figure}
...
\subsubsection[{\texorpdfstring{Newtonian\+\_\+ext\+Acc(double3 $\ast$acc, const double t, particle $\ast$p, const int np, particle $\ast$pert, double3 $\ast$pertf, const int npert, Newtonian\+\_\+pars $\ast$pars)}{Newtonian_extAcc(double3 *acc, const double t, particle *p, const int np, particle *pert, double3 *pertf, const int npert, Newtonian_pars *pars)}}]{\setlength{\rightskip}{0pt plus 5cm}template$<$class particle $>$ void N\+T\+A\+::\+Newtonian\+\_\+ext\+Acc (
\begin{DoxyParamCaption}
\item[{{\bf double3} $\ast$}]{acc, }
\item[{const double}]{t, }
\item[{particle $\ast$}]{p, }
\item[{const int}]{np, }
\item[{particle $\ast$}]{pert, }
\item[{{\bf double3} $\ast$}]{pertf, }
\item[{const int}]{npert, }
\item[{{\bf Newtonian\+\_\+pars} $\ast$}]{pars}
\end{DoxyParamCaption}
)}\hypertarget{namespaceNTA_a348d5b866ad9e50a51a398435e8b2ccd}{}\label{namespaceNTA_a348d5b866ad9e50a51a398435e8b2ccd}
...
\subsubsection[{\texorpdfstring{Newtonian\+\_\+kepler\+\_\+period(const double m1, const double m2, const double dx[3], const double dv[3], Newtonian\+\_\+pars $\ast$pars)}{Newtonian_kepler_period(const double m1, const double m2, const double dx[3], const double dv[3], Newtonian_pars *pars)}}]{\setlength{\rightskip}{0pt plus 5cm}double N\+T\+A\+::\+Newtonian\+\_\+kepler\+\_\+period (
\begin{DoxyParamCaption}
\item[{const double}]{m1, }
\item[{const double}]{m2, }
\item[{const double}]{dx\mbox{[}3\mbox{]}, }
