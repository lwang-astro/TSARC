...
\subsubsection[{\texorpdfstring{binomial\+\_\+recursive\+\_\+generator(int $\ast$bn, const int $\ast$bp, const std\+::size\+\_\+t n)}{binomial_recursive_generator(int *bn, const int *bp, const std::size_t n)}}]{\setlength{\rightskip}{0pt plus 5cm}void E\+P\+::binomial\+\_\+recursive\+\_\+generator (
\begin{DoxyParamCaption}
\item[{int $\ast$}]{bn, }
\item[{const int $\ast$}]{bp, }
...
\subsubsection[{\texorpdfstring{extrapolation\+\_\+error(double $\ast$$\ast$\+Tn, const std\+::size\+\_\+t Tsize, const std\+::size\+\_\+t n)}{extrapolation_error(double **Tn, const std::size_t Tsize, const std::size_t n)}}]{\setlength{\rightskip}{0pt plus 5cm}double E\+P\+::extrapolation\+\_\+error (
\begin{DoxyParamCaption}
\item[{double $\ast$$\ast$}]{Tn, }
\item[{const std\+::size\+\_\+t}]{Tsize, }
\item[{const std\+::size\+\_\+t}]{n}
\end{DoxyParamCaption}
...
\subsubsection[{\texorpdfstring{H\+\_\+opt\+\_\+factor(const double err, const double exp, const int n)}{H_opt_factor(const double err, const double exp, const int n)}}]{\setlength{\rightskip}{0pt plus 5cm}double E\+P\+::\+H\+\_\+opt\+\_\+factor (
\begin{DoxyParamCaption}
\item[{const double}]{err, }
...
\subsubsection[{\texorpdfstring{Hermite\+\_\+interpolation\+\_\+coefficients(double $\ast$$\ast$coff, const double $\ast$x, double $\ast$$\ast$f, double $\ast$$\ast$$\ast$df, const int ndata, const int npoints, const int $\ast$nlev)}{Hermite_interpolation_coefficients(double **coff, const double *x, double **f, double ***df, const int ndata, const int npoints, const int *nlev)}}]{\setlength{\rightskip}{0pt plus 5cm}void E\+P\+::\+Hermite\+\_\+interpolation\+\_\+coefficients (
\begin{DoxyParamCaption}
\item[{double $\ast$$\ast$}]{coff, }
\item[{const double $\ast$}]{x, }
\item[{double $\ast$$\ast$}]{f, }
\item[{double $\ast$$\ast$$\ast$}]{df, }
\item[{const int}]{ndata, }
\item[{const int}]{npoints, }
\item[{const int $\ast$}]{nlev}
\end{DoxyParamCaption}
...
\subsubsection[{\texorpdfstring{Hermite\+\_\+interpolation\+\_\+polynomial(double xn, double $\ast$fxn, double $\ast$$\ast$coff, const double $\ast$x, const int ndata, const int npoints, const int $\ast$nlev)}{Hermite_interpolation_polynomial(double xn, double *fxn, double **coff, const double *x, const int ndata, const int npoints, const int *nlev)}}]{\setlength{\rightskip}{0pt plus 5cm}void E\+P\+::\+Hermite\+\_\+interpolation\+\_\+polynomial (
\begin{DoxyParamCaption}
\item[{double}]{xn, }
\item[{double $\ast$}]{fxn, }
\item[{double $\ast$$\ast$}]{coff, }
...
\subsubsection[{\texorpdfstring{polynomial\+\_\+extrapolation(double $\ast$$\ast$\+Tn, double $\ast$\+Tnew, const int step[], const std\+::size\+\_\+t Tsize, const std\+::size\+\_\+t n)}{polynomial_extrapolation(double **Tn, double *Tnew, const int step[], const std::size_t Tsize, const std::size_t n)}}]{\setlength{\rightskip}{0pt plus 5cm}void E\+P\+::polynomial\+\_\+extrapolation (
\begin{DoxyParamCaption}
\item[{double $\ast$$\ast$}]{Tn, }
\item[{double $\ast$}]{Tnew, }
\item[{const int}]{step\mbox{[}$\,$\mbox{]}, }
\item[{const std\+::size\+\_\+t}]{Tsize, }
\item[{const std\+::size\+\_\+t}]{n}
\end{DoxyParamCaption}
...
\subsubsection[{\texorpdfstring{polynomial\+\_\+recursive\+\_\+formula(const double ti1k1, const double tik1, const double hr)}{polynomial_recursive_formula(const double ti1k1, const double tik1, const double hr)}}]{\setlength{\rightskip}{0pt plus 5cm}double E\+P\+::polynomial\+\_\+recursive\+\_\+formula (
\begin{DoxyParamCaption}
\item[{const double}]{ti1k1, }
\item[{const double}]{tik1, }
\item[{const double}]{hr}
\end{DoxyParamCaption}
...
\subsubsection[{\texorpdfstring{rational\+\_\+extrapolation(double $\ast$$\ast$\+Tn, double $\ast$\+Tnew, const int step[], const std\+::size\+\_\+t Tsize, const std\+::size\+\_\+t n)}{rational_extrapolation(double **Tn, double *Tnew, const int step[], const std::size_t Tsize, const std::size_t n)}}]{\setlength{\rightskip}{0pt plus 5cm}void E\+P\+::rational\+\_\+extrapolation (
\begin{DoxyParamCaption}
\item[{double $\ast$$\ast$}]{Tn, }
\item[{double $\ast$}]{Tnew, }
\item[{const int}]{step\mbox{[}$\,$\mbox{]}, }
...
\subsubsection[{\texorpdfstring{rational\+\_\+recursive\+\_\+formula(const double ti1k2, const double ti1k1, const double tik1, const double hr)}{rational_recursive_formula(const double ti1k2, const double ti1k1, const double tik1, const double hr)}}]{\setlength{\rightskip}{0pt plus 5cm}double E\+P\+::rational\+\_\+recursive\+\_\+formula (
\begin{DoxyParamCaption}
\item[{const double}]{ti1k2, }
\item[{const double}]{ti1k1, }
\item[{const double}]{tik1, }
\item[{const double}]{hr}
\end{DoxyParamCaption}
...
\subsubsection[{\texorpdfstring{seq\+\_\+\+B\+S(int step[], const std\+::size\+\_\+t itermax)}{seq_BS(int step[], const std::size_t itermax)}}]{\setlength{\rightskip}{0pt plus 5cm}void E\+P\+::seq\+\_\+\+BS (
\begin{DoxyParamCaption}
\item[{int}]{step\mbox{[}$\,$\mbox{]}, }
\item[{const std\+::size\+\_\+t}]{itermax}
\end{DoxyParamCaption}
...
\begin{center}
\leavevmode
\includegraphics[width=330pt]{namespaceEP_a1c85d6f300251929ac82736e54760652_icgraph}
\end{center}
\end{figure}
...
\subsubsection[{\texorpdfstring{seq\+\_\+\+Hairer(int step[], const std\+::size\+\_\+t itermax)}{seq_Hairer(int step[], const std::size_t itermax)}}]{\setlength{\rightskip}{0pt plus 5cm}void E\+P\+::seq\+\_\+\+Hairer (
\begin{DoxyParamCaption}
\item[{int}]{step\mbox{[}$\,$\mbox{]}, }
\item[{const std\+::size\+\_\+t}]{itermax}
\end{DoxyParamCaption}
...
\begin{center}
\leavevmode
\includegraphics[width=345pt]{namespaceEP_a691e74f494e1137b68389a2bd93f92c0_icgraph}
\end{center}
\end{figure}
...
\subsubsection[{\texorpdfstring{seq\+\_\+\+Harmonic(int step[], const std\+::size\+\_\+t itermax)}{seq_Harmonic(int step[], const std::size_t itermax)}}]{\setlength{\rightskip}{0pt plus 5cm}void E\+P\+::seq\+\_\+\+Harmonic (
\begin{DoxyParamCaption}
\item[{int}]{step\mbox{[}$\,$\mbox{]}, }
\item[{const std\+::size\+\_\+t}]{itermax}
\end{DoxyParamCaption}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{namespaceEP_a6197a74bc7ca232ffcc84872d8f4f779_icgraph}
\end{center}
\end{figure}
...
\subsubsection[{\texorpdfstring{seq\+\_\+\+Romberg(int step[], const std\+::size\+\_\+t itermax)}{seq_Romberg(int step[], const std::size_t itermax)}}]{\setlength{\rightskip}{0pt plus 5cm}void E\+P\+::seq\+\_\+\+Romberg (
\begin{DoxyParamCaption}
\item[{int}]{step\mbox{[}$\,$\mbox{]}, }
\item[{const std\+::size\+\_\+t}]{itermax}
\end{DoxyParamCaption}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{namespaceEP_afaef3617ed3fb4ad4627c19e955c5457_icgraph}
\end{center}
\end{figure}
